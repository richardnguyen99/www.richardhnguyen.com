      ...
      <div className="flex flex-wrap gap-2">
        {tags.map((tag) => (
          <Link key={tag} href={`/blogs?tags=${tag}`}>
            <span className="rounded-lg border border-neutral-400 bg-neutral-200 px-2 py-1 font-mono text-xs font-medium hover:border-neutral-500 hover:bg-neutral-300 lg:text-sm dark:border-neutral-600 dark:bg-neutral-800 dark:hover:border-neutral-500 dark:hover:bg-neutral-700">
              {tag}
            </span>
          </Link>
        ))}
