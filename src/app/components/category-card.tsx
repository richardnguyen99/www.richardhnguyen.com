...
interface CategoryCardProps extends React.HTMLAttributes<HTMLLIElement> {
  key: React.Key;
  post: MdxContent;
}
...
export default function CategoryCard({
  ...
  return (
    <li
      {...props}
      key={props.key}
      data-slice-index={props.key}
      className="group relative flex aspect-3/4 w-52 shrink-0 snap-start scroll-ml-(--gutter-size) flex-col justify-end overflow-hidden rounded-xl sm:aspect-3/4 sm:w-64 sm:rounded-xl md:w-72 md:rounded-2xl lg:w-80"
    >
          ...
          <div className="relative z-50 h-full w-full">
            <div className="text-4 absolute top-4 left-0 flex w-full flex-wrap items-center gap-2 text-gray-200">
              <div className="ml-4 truncate">
                <span className="block w-12.5 max-w-12.5 overflow-hidden text-xs leading-[1.3] text-ellipsis whitespace-nowrap md:w-[unset] md:max-w-[unset]">
