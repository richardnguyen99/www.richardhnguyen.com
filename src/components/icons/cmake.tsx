...
const CMakeIcon: React.FC = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      >
        <stop offset="0" stopColor="#1011a1" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#b40e0e" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#01a300" />
    ...
    <path
      d="M17.257,16.919,2.246,29.749,15.994,2.283Z"
      style={{ fill: "url(#a)" }}
    />
    ...
    <path
      d="M17.952,24.931,16,2.28,29.767,29.751Z"
      style={{ fill: "url(#b)" }}
    />
    ...
    <path
      d="M11.189,22.112l6.059-5.168.843,7.98Z"
      style={{ fill: "url(#d)" }}
    />
