...
> required. In fact, TCP Tahoe, a congestion control algorithm, does not have
> a fast recovery phase whereas TCP Reno, another congestion control algorithm,
> implements the fast recovery phase.
