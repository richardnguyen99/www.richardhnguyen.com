...
TCP traffic[^1], while the rest is UDP traffic. It was developed in the 1970s
by [Vint Cerf](https://www.internethalloffame.org/vint-cerf/) and [Robert Kahn](
https://www.internethalloffame.org/inductee/robert-kahn/) to build a reliable
client-server communication using
<GlossaryItem term="packet-switch">packet switching</GlossaryItem>.
